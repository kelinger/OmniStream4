...
clone_omnistream_project() {
    ...
    # Progress dialog for project cloning
    {
        ...
        echo "70" ; echo "Creating project directories..."
        mkdir -p "${INSTALL_DIR}/configs"
        mkdir -p "${INSTALL_DIR}/enabled"
...
# wget -O - https://raw.githubusercontent.com/[your-repo]/omnistream-install.sh | bash
